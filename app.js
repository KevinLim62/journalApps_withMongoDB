...
//Express and EJS template setting
const app = express();
...
app.get("/posts/:topics", function(req, res) {
  ...
  let param = req.params.topics;


  Content.find({}, function(err, founditems) {

    founditems.forEach(function(content) {
      if (lodash.lowerCase(content.title) === lodash.lowerCase(param)) {
        res.render("post", {
